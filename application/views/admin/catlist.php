...
border-radius:5px;
  ...
  <tbody>
    ...
    <tr class="table-default">
      <td><?= ++$count;?></th>
      <td ><?php echo $categorie->catName;?></th>
      <td>
        <?= anchor("Category/edit_category/{$categorie->id}",'Edit',['class'=>'btn btn-primary']);?></td>
        <td>
        <?=
            form_open('Category/delete_category'),
            form_hidden('cat_id', $categorie->id),
