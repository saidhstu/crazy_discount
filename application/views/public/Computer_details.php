...
<div id="sidebar-left">	
	<h2>Categories</h2>
			<ul>
			      <li><a href="<?= base_url('View_product/desktop')?>">Desktop</a></li>
			      <li><a href="<?= base_url('View_product/laptop') ?>">Laptop</a></li>
			      <li><a href="<?= base_url('View_product/monitor') ?>">Monitor</a></li>
			      <li><a href="<?= base_url('View_product/printer') ?>">Printer</a></li>
...
<div class="maincontent" style="min-height:700px;">
			       ...
			       <div class="row">
							  ...
							  <div class="col-md-3">
							  	...
							  	<p><span class="price" style="color:green">Main price: ৳<?php echo $getproducts->main_price;?></span></p>
							   <p><span class="price"style="color:green">Discount: <?php echo $getproducts->percentage;?>%</span></p>

							 <p><span class="price" style="color:green">Offer price: ৳<?php echo $getproducts->offer_price;?></span></p>
							  <p><span class="price" style="color:green">Offer Start date: <?php echo $getproducts->start_date;?></span></p>
							   <p><span class="price"style="color:green">Offer End Date:<?php echo $getproducts->end_date;?></span></p>

							</div>
							  <div class="col-md-4" style="background:#ddd">
							  	<h3 style="color:green;margin-top:0px">Product Source</h3>
							  	<p style="border:none;color:green"><?php echo $getproducts->source;?></p>
							</div>
