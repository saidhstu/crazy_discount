...
<div id="sidebar-left">
	<h2>Brands</h2>
   <ul>
      <li><a href="<?= base_url('View_product/view_Laptop_Apple')?>">Apple</a></li>
      <li><a href="<?= base_url('View_product/view_Laptop_samsung')?>">Samsung</a></li>
      <li><a href="<?= base_url('View_product/view_Laptop_Asus')?>">Asus</a></li>
      <li><a href="<?= base_url('View_product/view_Laptop_HP')?>">HP</a></li>
      <li><a href="<?= base_url('View_product/view_Laptop_Dell')?>">Dell</a></li>
	   <li><a href="<?= base_url('View_product/view_Laptop_Acer')?>">Acer</a></li>
	   <li><a href="<?= base_url('View_product/view_Laptop_Acer')?>">Doyel</a></li>
	   <li><a href="<?= base_url('View_product/view_Laptop_Acer')?>">Lenevo</a></li>
	   <li><a href="<?= base_url('View_product/view_Laptop_Acer')?>">Thosiba</a></li>
	</ul>
