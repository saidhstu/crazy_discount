...
<div id="sidebar-left">
	<h2>Brands</h2>
<ul>
      <li><a href="<?= base_url('View_product/view_cell_phone_Apple')?>">Apple</a></li>
      <li><a href="<?= base_url('View_product/view_cell_phonesamsung')?>">Samsung</a></li>
      <li><a href="<?= base_url('View_product/view_cell_phone_Nokia')?>">Nokia</a></li>
      <li><a href="<?= base_url('View_product/view_cell_phone_HTC')?>">HTC</a></li>
      <li><a href="<?= base_url('View_product/view_cell_phone_Huawei')?>">Huawei</a></li>
	   <li><a href="<?= base_url('View_product/view_cell_phone_Walton')?>">Walton</a></li>
	   <li><a href="<?= base_url('View_product/view_cell_phone_Sony')?>">Sony</a></li>
	   <li><a href="<?= base_url('View_product/view_cell_phone_Oppo')?>">Oppo</a></li>
	   <li><a href="<?= base_url('View_product/view_cell_phone_Micromax')?>">Micromax</a></li>
	   <li><a href="<?= base_url('View_product/view_cell_phpne_Symphoni')?>">Symphoni</a></li>
	</ul>
