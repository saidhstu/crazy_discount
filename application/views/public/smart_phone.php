...
<div id="sidebar-left">
	<h2>Brands</h2>
<ul>
      <li><a href="<?= base_url('View_product/view_mobile_Apple')?>">Apple</a></li>
      <li><a href="<?= base_url('View_product/view_samsung')?>">Samsung</a></li>
      <li><a href="<?= base_url('View_product/view_mobile_Nokia')?>">Nokia</a></li>
      <li><a href="<?= base_url('View_product/view_mobile_HTC')?>">HTC</a></li>
      <li><a href="<?= base_url('View_product/view_mobile_Huawei')?>">Huawei</a></li>
	   <li><a href="<?= base_url('View_product/view_mobile_Walton')?>">Walton</a></li>
	   <li><a href="<?= base_url('View_product/view_mobile_Sony')?>">Sony</a></li>
	   <li><a href="<?= base_url('View_product/view_mobile_Oppo')?>">Oppo</a></li>
	   <li><a href="<?= base_url('View_product/view_mobile_Micromax')?>">Micromax</a></li>
	   <li><a href="<?= base_url('View_product/view_mobile_Symphoni')?>">Symphoni</a></li>
	</ul>
