...
<h2>Brands</h2>
		<ul>
	      <li><a href="<?= base_url('View_product/view_monitor_Apple')?>">Apple</a></li>
	      <li><a href="<?= base_url('View_product/view_monitor_samsung')?>">Samsung</a></li>
	      <li><a href="<?= base_url('View_product/view_monitor_Asus')?>">Asus</a></li>
	      <li><a href="<?= base_url('View_product/view_monitor_HP')?>">HP</a></li>
	      <li><a href="<?= base_url('View_product/view_monitor_Dell')?>">Dell</a></li>
		   <li><a href="<?= base_url('View_product/view_Monitor_Acer')?>">Acer</a></li>
		   <li><a href="<?= base_url('View_product/view_monitor_Sony')?>">Sony</a></li>
		  
		</ul>
</div>
<div id="main">

<div class="maincontent" style="height:700px;">
